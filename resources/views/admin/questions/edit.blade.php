...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-edit"></i> Edit Question #{{ $question->id }}</h2>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="fas fa-edit"></i> Question Details</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h6 class="mb-0"><i class="fas fa-chart-bar"></i> Question Statistics</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="text-center">
                            <h6>Times Used</h6>
                            <p class="text-muted">{{ $question->answers()->count() }} answers</p>
                        </div>
                    </div>
                </div>
            </div>
